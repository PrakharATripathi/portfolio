...
const Footer = () => {
  return (
    <motion.footer 
      className="py-6 text-center text-secondary text-sm"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-4">
          ...
          <span className="block w-full md:w-auto">|</span>
          <a 
            href="mailto:tripathiprakhar175@gmail.com" 
          ...
          >
            ...
            tripathiprakhar175@gmail.com
          </a>
        </div>
        <div className="mt-4 text-xs">
          <p>© {new Date().getFullYear()} Prakhar Tripathi. All rights reserved.</p>
